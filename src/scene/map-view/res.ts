...
export class Res {
	...
	prepareTextures(): void {
		...
		createTileTexture("tile-default", 0x808080)
		createTileTexture("tile-empty", 0xD3D3D3)
		createTileTexture("tile-ore", 0xFFD700)
		createTileTexture("tile-water", 0x0000FF)
		createTileTexture("tile-stone", 0x555555)     
		createTileTexture("tile-crystal", 0x00FFFF)
		createTileTexture("building-crusher", 0xCCAAAA, 0xA9A9A9, "C")
		createTileTexture("building-power-station", 0xCCAAAA, 0xA9A9A9, "P")
	}
